...
SCALE=${SCALE:-100}  # times 1M records
...
for i in {1..100}; do
    ...
    $PSQL $PGCONN -q -t -c "insert into dots_uniform (id,w,h, citus_distribution_id) select id, (random()*1000000)::bigint, (random()*1000000)::bigint, (random()*2147483648*2.0 - 2147483648)::int from generate_series(1,10000*$SCALE) id;"
done
